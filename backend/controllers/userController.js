...
const createToken = (id) => {
    return jwt.sign({ id: id }, process.env.ACCESS_TOKEN_SECRET, { expiresIn: maxAgeToken })
}
...
const handleLoginSql = async (req, res) => {
    ...
    try {
        ...
        res.cookie('jwt', token, { httpOnly: true, sameSite: 'None', maxAge: maxAgeCookie }) // // dont forget to change it to sameSite: 'None', secure: true, under production
